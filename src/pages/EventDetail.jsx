...
export default function EventDetail() {
  ...
  if (!event) {
    return (
      <div className="custom-page-container">
        <h1 className="custom-page-title" style={{ marginTop: '5rem' }}>Event not found</h1>
        <button className="back-btn" onClick={() => navigate(-1)} style={{ margin: '0 auto' }}>
  ...
  return (
    <div className="event-detail-page">
      ...
      <div className="custom-page-container ed-container">
        ...
        <div className="ed-content-wrapper">
          ...
          <div className="ed-cta-wrapper">
            <button className="cta-primary" onClick={() => navigate('/booking')}>
              <span>BOOK NOW</span>
            </button>
          </div>
        </div>
